...
TABLES['logements'] = (
    ...
    "   PRIMARY KEY (`id`),"
    "   KEY `logement_ibfk_1` (`commune_id`),"
    "   KEY `logement_ibfk_2` (`type_logement_id`),"
    "   CONSTRAINT `logement_ibfk_1` FOREIGN KEY (`commune_id`) "
    "       REFERENCES `communes` (`id`) ON DELETE SET NULL,"
    "   CONSTRAINT `logement_ibfk_2` FOREIGN KEY (`type_logement_id`) "
    "       REFERENCES `types_logement` (`type`) ON DELETE SET NULL"
    ") ENGINE=InnoDB"
)
...
TABLES['telephones'] = (
    ...
    "   KEY `telephone_ibfk_1` (`locataire_id`),"
    "   CONSTRAINT `telephone_ibfk_1` FOREIGN KEY (`locataire_id`) "
    "       REFERENCES `locataires` (`id`) ON DELETE CASCADE"
    ")  ENGINE=InnoDB"
)
...
TABLES['contrats_de_location'] = (
    ...
    "   PRIMARY KEY (`id`),"
    "   KEY `contrat_de_location_ibfk_1` (`locataire_id`),"
    "   KEY `contrat_de_location_ibfk_2` (`logement_id`),"
    "   CONSTRAINT `contrat_de_location_ibfk_1` FOREIGN KEY (`locataire_id`) "
    "       REFERENCES `locataires` (`id`) ON DELETE SET NULL,"
    "   CONSTRAINT `contrat_de_location_ibfk_2` FOREIGN KEY (`logement_id`) "
